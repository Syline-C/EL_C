...
class memoryMap():
    ...
    def __init__(self, env):
        ...
        """ 
        self.memoryAddr = {
                            'x_position'        :   'self.core.ram[0x6d] * 0x100 + self.core.ram[0x86]',
                            'left_x_position'   :   'np.uint8(int(self.core.ram[0x86]) - int(self.core.ram[0x071c])) % 256',
                            'y_pixel'           :   'self.core.ram[0x03b8]',
                            'y_viewport'        :   'self.core.ram[0x00b5]',
                            'player_state'      :   'self.core.ram[0x000e]',
                            'life'              :   'self.core.ram[0x075a]',
                            'world_state'       :   'self.core.ram[0x0770]',
                            'life'              :   'self.core.ram[0x075a]',
                            'screen_edge_x_pos' :   'self.core.ram[0x071c]',
                            'move_screen_x_pos' :   'self.core.ram[0x071d]',
    ...
    def _read_mem_range(self, address, length):
        ...
        return int(''.join(map(str, self.core.ram[address:address + length])))
